...
import img1 from '../images/senior-woman.png'
...
const Navigation = () => {
    return (
        <nav className='navbar'>
            ...
            <ul>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="15.509" height="17" viewBox="0 0 15.509 17">
                ...
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="23.733" height="17" viewBox="0 0 23.733 17">
                ...
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="15.119" height="17" viewBox="0 0 15.119 17">
            ...
            <div className='flex items-center justify-center'>
                <img src={img1} alt="woman dr." className='w-[35px] h-[35px]' />
                <div className='flex flex-col justify-start items-center'>
                    <b className='leading-[5px] text-[0.6rem]'>Dr. Jose Simmons</b>
                    <p className='pt-1 text-[0.6rem]'>General Practioner</p>
                </div>
            </div>
        </nav>
    )
